...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RoslynVisugSampleApiAnalyzerCodeFixProvider)), Shared]
    public class RoslynVisugSampleApiAnalyzerCodeFixProvider : CodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds
        {
            get { return ImmutableArray.Create(RoslynVisugSampleApiAnalyzerAnalyzer.DiagnosticId); }
        }
