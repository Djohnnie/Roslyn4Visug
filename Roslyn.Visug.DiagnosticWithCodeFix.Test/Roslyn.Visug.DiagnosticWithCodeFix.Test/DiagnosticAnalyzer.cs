...
namespace Roslyn.Visug.DiagnosticWithCodeFix.Test
{
    ...
    public class RoslynVisugDiagnosticWithCodeFixTestAnalyzer : DiagnosticAnalyzer
    {
        public const string DiagnosticId = "RoslynVisugSampleApiAnalyzer";

        // You can change these strings in the Resources.resx file. If you do not want your analyzer to be localize-able, you can use regular strings for Title and MessageFormat.
        internal static readonly LocalizableString Title = "TITLE";
        internal static readonly LocalizableString MessageFormat = "FORMAT";
